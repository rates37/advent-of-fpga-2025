...
let module Circuit = Circuit.With_interface (Day01.Day01_core.I) (Day01.Day01_core.O) in 
let circuit = Circuit.create_exn ~name:"u_day01_0" (Day01.Day01_core.create scope) in
