...
let circuit = Circuit.create_exn ~name:"u_day12_0" (Core.create scope) in
...
let o_part_1 = List.assoc "result" outputs in
let o_done = List.assoc "done_" outputs in
